...
@section('title', 'Laporan Pinjaman - Koperasi MAN Insan Cendekia')
@section('content')
...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Laporan Pinjaman</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<div class="container"> 
    ...
    <div class="card mb-2">
        <div class="card-header text-right">
            <a class="btn btn-primary mb-1 text-right ml-2" href="{{url('laporan-pinjaman-detailPdf', $bulan)}}" style="color: white; float: right">Cetak</a>
        </div>
        @if(session()->get('role')!='Anggota')
        <div class="card-header">
          <form class="form-group" action="{{url('laporan-pinjaman-search')}}" method="GET" enctype="multipart/form-data">
              @csrf
              <div class="row">
                <div class="form-group col-6">
                    <select class="form-control" name="bulan" required>
                      <option value="">Pilih Bulan Pinjaman</option>
                      @php
